...
DECLARE @BuyerId1 INT = (SELECT TOP 1 Id FROM usr.Users WHERE [Name] = 'Monika' AND [Surname] = 'Marcinkowska');
...
SELECT TOP 1 @ModelersionId = mv.[Id]
  ...
  WHERE mv.VersionName = 'STYLE 2.0 TDI' and m.[Name] = 'Octavia Liftback'
...
VALUES (@ModelersionId, @BuyerId1, @SellerId2, GETDATE() - 100, GETDATE() - 3, @PriceId);
